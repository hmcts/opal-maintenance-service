...
COMMENT ON COLUMN public.business_units.business_unit_code      IS 'Unique Business Unit code';
COMMENT ON COLUMN public.business_units.business_unit_name      IS 'Business Unit display name';
COMMENT ON COLUMN public.business_units.business_unit_type      IS 'Area or Accounting Division';
COMMENT ON COLUMN public.business_units.account_number_prefix   IS 'Accounting Division prefix used before account numbers';
COMMENT ON COLUMN public.business_units.parent_business_unit_id IS 'Self-reference to the parent Business Unit';
COMMENT ON COLUMN public.business_units.opal_domain             IS 'When business unit type is Accounting Division, then this value is the opal domain that the business unit is owned by';
COMMENT ON COLUMN public.business_units.welsh_language          IS 'Whether Welsh-language operation applies';
